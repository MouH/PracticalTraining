...
<link href="css/stock.do.css" rel="stylesheet" type="text/css" />
...
<div id="templatemo_container">
    ...
    <div id="templatemo_menu_search">
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="SaleOrBuyServlet" class="current">股票交易</a></li>
    ...
    <div id="templatemo_content">
    	...
    	<div class="section_w650 fl">
			...
			<div >	
			<form onsubmit="return  myfu()" action="StockDoServlet" method="post">
				...
				<table  border="1" cellpadding="0" bordercolorlight="#999999" bordercolordark="#FFFFFF" cellspacing="0" align="center">
					<tbody>
						<tr>
							...
							<c:forEach var="s" items="${stock}" varStatus="dd">
            			...
            			<div>
            <form onsubmit="return  myfu2()" action="StockDoServlet2" method="post">
				<div >
					<table  border="1" cellpadding="0" bordercolorlight="#999999" bordercolordark="#FFFFFF" cellspacing="0" align="center">
						<tbody>
							<c:if test="${flag}">						
							<tr>
								...
								<td><select name="stock_id">
										...
										<option value="0">无股票卖</option>


									</select>
							    </td>
								<td>卖出价格</td><td><input type="text" name="price2" size="5"></td>
								<td>卖出数量</td>
							...
							<tr>
								<td>请选择卖出股票</td> 
								<td><select name="stock_id">
										<c:forEach var="h" items="${holding}" varStatus="dd">
										<option value="${h.stock.id}">${h.stock.name}</option>
										</c:forEach>
									</select>
							    </td>
								<td>卖出价格</td><td><input type="text" name="price2" size="5"></td>
				...
				<div>
					<table width="70%" border="1" cellpadding="0" bordercolorlight="#999999" bordercolordark="#FFFFFF" cellspacing="0" align="center">
						...
						<c:if test="${flag}">
						<tr>
							<td height="50" colspan="8" align="center">对不起，未持仓</td>
						</tr>
						</c:if>
						<c:if test="${flag==false}">
						<c:forEach var="t" items="${holding}" varStatus="dd">
    				    ...
    				    <td  align="center"><c:out value="${t.number}"/></td>
						<td  align="center"><c:out value="${t.avgPrice}"/></td>
						<td  align="center"><c:out value="${t.stock.price}"/></td>
						</tr>
						</c:forEach>
